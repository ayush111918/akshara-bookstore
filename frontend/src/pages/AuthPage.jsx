    ...
    <section className="auth-page">
      ...
      <div className="auth-panel auth-form-panel">
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          <label>Password<input name="password" type="password" value={form.password} onChange={updateField} minLength={isRegister ? 8 : undefined} maxLength="72" required /></label>
